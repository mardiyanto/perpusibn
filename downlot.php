...
$direktori = "foto/fileupload/"; // folder tempat penyimpanan file yang boleh didownload
$filename = $_GET['file'];
...
if(file_exists($direktori.$filename)){
	...
	if ($file_extension=='php'){
	  ...
	  $query = mysqli_query($koneksi, "UPDATE tbl_buku SET baca=baca+1 WHERE file_upload='$filename'");
